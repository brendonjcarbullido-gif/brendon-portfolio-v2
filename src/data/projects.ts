...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      headline: "Building an Artist's World.",
      overview:
        "Built Kandeyce Jorden's social presence and visual brand from zero — executing all content planning, curation, and production independently.",
      role: 'Art Director',
      deliverables: ['Brand Identity', 'Social Media', 'Content Production'],
